...
class ComposeForm extends ImmutablePureComponent {
  ...
  canSubmit = () => {
    ...
    return !(isSubmitting || isUploading || isChangingUpload || length(fulltext) > 11270 || (isOnlyWhitespace && !anyMedia));
  }
      ...
      <div className='compose-form'>
        ...
        <div className='compose-form__buttons-wrapper'>
          ...
          <div className='character-counter__wrapper'>
            <CharacterCounter max={11270} text={this.getFulltextForCharacterCounting()} />
          </div>
        </div>
